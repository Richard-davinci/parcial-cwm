  ...
  <div class="flex items-center gap-4 pt-3 border-t border-gray-700">
    ...
    >
      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M21,6H3A1,1,0,0,0,2,7V17a3,3,0,0,0,3,3H16.59l3.7,3.71A1,1,0,0,0,21,24a.84.84,0,0,0,.38-.08A1,1,0,0,0,22,23V7A1,1,0,0,0,21,6ZM20,20.59l-2.29-2.3A1,1,0,0,0,17,18H5a1,1,0,0,1-1-1V8H20Z"/>
      </svg>
      <span class="text-sm">
